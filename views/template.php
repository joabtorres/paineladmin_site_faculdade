...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta property="ogg:title" content="Painel Administrativo Cavanis">
        <meta property="ogg:description" content="Painel Administrativo Cavanis">
        <title>Painel Administrativo Cavanis</title>
        <!-- Bootstrap -->
        ...
        <div id="tela_sistema">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo BASE_URL ?>cadastrar/slide"><i class="fas fa-plus"></i> Slide</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo BASE_URL ?>consultar/slide"><i class="fas fa-search"></i> Slide</a></li>
                                    <li role="separator" class="divider"></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        <div id="rodape" >
                            <p class="text-right" style="color: #666">&copy; Copyright 2020 - <a href="http://lattes.cnpq.br/0856780614635850" target="_blank" style="color: #666">Joab Torres Alencar</a></p>
                        </div>
                    </div>
                </div>
            </div>
