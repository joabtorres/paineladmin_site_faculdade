...
class usuario extends model {
    ...
    public function create($data) {
        $sql = $this->db->prepare('INSERT INTO usuario (nome, email, senha, imagem, status) VALUES (:nome, :email, :senha, :imagem, :status)');
    ...
    public function update($data) {
        try {
            if (isset($data['senha']) && !empty($data['senha'])) {
                $sql = "UPDATE usuario SET nome=:nome, email=:email, senha=:senha, imagem=:imagem, status=:status WHERE id=:id";
            } else {
                $sql = "UPDATE usuario SET nome=:nome, email=:email, imagem=:imagem, status=:status WHERE id=:id";
            }
